...
def main():
    ...
    for problem_type_idx, problem_type in enumerate(problem_types):
        for instance_idx, instance_name in enumerate(instance_names[problem_type_idx]):
            with open(raw_results_folder + "/" + problem_type + "/" + instance_name + "/" + "LROutputs" + "/" + "LR_outputs.csv", "r") as LR_input_fs:
                decomp_idx_list = []
                input_csvreader = csv.reader(LR_input_fs, delimiter=",")
                ...
                if len(decomp_idx_list) != len(set(decomp_idx_list)):
                    ...
                    delete_initial_run(raw_results_folder + "/" + problem_type + "/" + instance_name)
