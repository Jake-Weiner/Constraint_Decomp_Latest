...
def main():
    ...
    for problem_idx, problem_type in enumerate(problem_types):
        ...
        for instance_idx, instance_name in enumerate(instance_names[problem_idx]):
            LR_decomp_input_path = processed_results_folder + "/" + problem_type + "/" + instance_name + "/" + "Normalised_Data" + "/" + "LROutputs" + "/" + "LR_outputs_gaps.csv"
            ...
            normaliseLRGaps(LR_decomp_input_path, LR_decomp_output_path)
