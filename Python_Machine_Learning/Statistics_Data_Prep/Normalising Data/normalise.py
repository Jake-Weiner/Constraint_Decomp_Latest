...
subproblem_normalisation_filenames = ["Sum_obj.csv", "Sum_abs_obj.csv", "Obj_range.csv", "average_RHS.csv", "average_abs_RHS.csv", "Largest_RHSLHS.csv", "RHS_range.csv"]

relaxed_constraints_normalisation_filenames = ["Largest_RHSLHS.csv", "Sum_obj.csv", "Sum_abs_obj.csv", "RHS_vals.csv"]
...
input_subproblems_folder = "/home/jake/PhD/Decomposition/Massive/Machine_Learning/output/network_flow/cost266-UUE.mps/Raw_Data/Subproblem_Statistics"
output_subproblems_folder = "/home/jake/PhD/Decomposition/Massive/Machine_Learning/output/network_flow/cost266-UUE.mps/Normalised_Data/Subproblem_Statistics"
#instance statistics
...
def normalise(min, max, input_file, output_file):
...
#normalise based on decomposition values which are calculated on the fly
...
def main():
    ...
    for idx, filename in enumerate(relaxed_constraints_normalisation_filenames):
        normalise(relaxed_constraints_normalisation_min_max[idx][0], relaxed_constraints_normalisation_min_max[idx][1]
        ,relaxed_constraint_input_folder + "/" + filename, output_relaxed_constraint_folder + "/" + filename)

    #normalised subproblem data based on subproblem values
    for filename in subproblem_normalisation_filenames:
        normaliseSubproblems(input_subproblems_folder + "/" + filename, output_subproblems_folder + "/" + filename)
