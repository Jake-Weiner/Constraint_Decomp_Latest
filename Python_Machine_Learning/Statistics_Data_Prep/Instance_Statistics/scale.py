...
def main():
    ...
    raw_results_root_folder = "/media/jake/Jakes_Harddrive/PhD/Decomposition/Machine_Learning/Massive_Outputs"
    ...
    for problem_idx, problem_type in enumerate(problem_types):
        ...
        for instance_idx, instance_name in enumerate(instance_names[problem_idx]):
            ...
            for raw_results_filename in raw_result_filenames:
                ...
                for feature_type in raw_result_feature_types:
                    if feature_type == "mean":
                        ...
                        feature_list.append((stat_type + "_" + feature_type, df_temp['Scaled Data'].std(ddof=0)))
            print(feature_list)
            ...
            if not Path(output_path).is_file():
                with open(output_folder + "/" + "Instance_Features.csv", "w") as output_fs:
            ...
            with open(output_folder + "/" + "Instance_Features.csv", "a+") as output_fs:
                output_fs.write(instance_name + "," + problem_type + ",")
                for feature_tuple in feature_list[0:len(feature_list) - 2]:
            ...
            # write out features to output file
