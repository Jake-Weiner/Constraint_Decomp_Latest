...
def main():
    ...
    processed_results_external_folder = "/media/jake/Jakes_Harddrive/PhD/Decomposition/Machine_Learning/Processed_Results"
    ...
    for problem_idx, problem_type in enumerate(problem_types):
        for instance_idx, instance_name in enumerate(instance_names[problem_idx]):
            ...
            input_features_folder = processed_results_local_folder + "/" + problem_type + "/" + instance_name + "/" + "Features_Calculated"
