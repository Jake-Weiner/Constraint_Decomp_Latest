...
instance_names = [["cost266-UUE.mps", "dfn-bwin-DBE.mps", "germany50-UUM.mps", "ta1-UUM.mps", "ta2-UUE.mps"],
                          ...
                          ["snp-02-004-104.mps", "snp-04-052-052.mps", "snp-06-004-052.mps", "snp-10-004-052.mps",
                           "snp-10-052-052.mps"]]
output_folder = "/home/jake/PhD/Machine_Learning/Processed_Results/Machine_Learning_Outputs/Voting_vs_decomp"
...
for problem_type_idx, problem_type in enumerate(problem_types):
    for instance_idx, instance_name in enumerate(instance_names[problem_type_idx]):
        ...
        df_prediction = pd.read_csv("{}/{}/{}/{}/{}_{}.csv".format(features_calculated_folder, problem_type, instance_name,"Decomp_Method_Scores","Voting_all_problem_types",instance_name))
