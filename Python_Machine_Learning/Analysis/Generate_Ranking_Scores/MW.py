    ...
    for problem_type_idx, problem_type in enumerate(problem_types):
        ...
        for instance_idx, instance_name in enumerate(instance_names_testing[problem_type_idx]):
            for batch_number in range(number_of_batches):
                ...
                var_props_path = external_processed_results_folder + "/" + problem_type + "/" + instance_name + "/" + str(batch_number) + "/" + "Normalised_Data" + "/" +"Subproblem_Statistics" + "/" + "Var_props.csv"
                constr_props_path = external_processed_results_folder + "/" + problem_type + "/" + instance_name + "/" + str(batch_number) + "/" + "Normalised_Data" + "/" + "Subproblem_Statistics" + "/" + "Const_props.csv"
                ranking_scores_output_folder = features_calculated_folder + "/" + problem_type + "/" + instance_name + "/" + str(
                    batch_number) + "/" + "Ranking_Method_Scores"
                Path(ranking_scores_output_folder).mkdir(parents=True, exist_ok=True)
                MW_output_path = ranking_scores_output_folder + "/" + "MW_Scores.csv"
