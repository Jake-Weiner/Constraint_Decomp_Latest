...
def main():
    ...
    ranking_methods_root_folder = "/media/jake/Jakes_Harddrive/PhD/Decomposition/Machine_Learning/Processed_Results/Generate_Ranking_Scores"
    ...
    heuristic_measures = ['RBA', 'Goodness', 'GCG1', 'MW']
    batch_numbers = 10
    for problem_type_idx, problem_type in enumerate(problem_types):
        ...
        for instance_idx, instance_name in enumerate(instance_names_testing[problem_type_idx]):
            for batch_number in range(batch_numbers):
                ...
                input_data_filepath = processed_results_folder + "/" + problem_type + "/" + instance_name + "/" + batch_number + "/" + "Features_Collated" + "/" + "collated.csv"
