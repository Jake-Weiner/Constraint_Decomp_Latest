...
def main():
    ...
    for name, model in models:
        ...
        cv_results = cross_val_score(model, X_np, Bound_np, cv=kfold, scoring="neg_mean_squared_error")
    ...
    with open(cfv_results_path + "/" + "all_problem_types" + "_summary", "a+") as results_output_fs:
    ...
    plt.show()
    plt.savefig(cfv_results_path + "/" + "all_problem_types" + "_box_plot")
