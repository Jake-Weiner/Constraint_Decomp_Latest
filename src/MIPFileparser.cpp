...
void MIPFileparser::parserMps(string filename)
{
...
void MIPFileparser::parse(file_type ft, string filename)
{
...
// user defined format
void MIPFileparser::parserUser(string filename)
{
...
void MIPFileparser::createConstraint(const vector<string>& line_split, unsigned int& current_constraint_number)
{
...
void MIPFileparser::extractVariableInfo(vector<string>& line_split, const string& variable_name)
{
...
void MIPFileparser::extractRHSInfo(const vector<string>& line_split)
{
...
void MIPFileparser::extractBoundsInfo(const vector<string>& line_split)
{
    Bounds_type bt;
...
void MIPFileparser::printConstraints()
{
...
void MIPFileparser::printVariables()
{
